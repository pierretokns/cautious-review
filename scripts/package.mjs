...
const expected=['THIRD_PARTY_NOTICES.txt','assist.js','session-entry.js','session-resume.js','session-reader.js','session-reader.html','session-ui.js','session-observer.js','session-diagnostics.js','batch.js','background.js','content.js','core.js','evidence.js','storage.js','manifest.json','harvest.js','identity.js','live-store.js','live.js','pdf.js','semantic.js','live.html','live.css','launcher.html',
