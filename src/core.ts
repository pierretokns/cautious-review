// Greenhouse documents recruiter shards as app[#].greenhouse.io. Keep the
// extension grants finite and explicit instead of allowing arbitrary tenants.
export const HOSTS = new Set(["app.greenhouse.io", ...Array.from({ length: 14 }, (_, index) => `app${index + 2}.greenhouse.io`), "app.eu.greenhouse.io"]);
